...
from ._anntorchdataset import SpatialAnnTorchDataset

logger = logging.getLogger(__name__)


class SpatialAnnDataLoader(DataLoader):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if load_sparse_tensor:
            raise UserWarning("SpatialAnnDataLoader does not support loading sparse tensors for nearest neighbors.")

        if distributed_sampler:
            raise UserWarning("SpatialAnnDataLoader does not support distributed sampler.")
        ...
        # Create SpatialAnnTorchDataset which respects NN indices
        self.dataset = SpatialAnnTorchDataset(
            adata_manager,
