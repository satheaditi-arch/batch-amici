"""
BA-AMICI PBMC Dataset Preparation Script - FIXED VERSION
Uses Scanpy's built-in datasets and alternative download methods
"""
...
def visualize_results(adata):
    ...
    sc.pl.umap(adata, color=['batch', 'leiden'], 
               save='_batch_overview.png', show=False)
    
    # PCA colored by batch
    print("Generating PCA plot...")
    sc.pl.pca(adata, color='batch', 
              save='_batch_pca.png', show=False)
