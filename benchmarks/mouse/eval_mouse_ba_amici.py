# benchmarks/mouse/06_eval_mouse_ba_amici.py
...
MODEL_PATH = os.path.join(PROJECT_ROOT, "results", "mouse", "ba_amici", "model.pt")
FIG_DIR = os.path.join(PROJECT_ROOT, "results", "mouse", "ba_amici", "figures")
...
sc.pl.umap(adata, color="batch", save="_ba_batch.png",
           show=False)
print(" BA-AMICI evaluation plots saved.")