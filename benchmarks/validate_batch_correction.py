...
def load_model_and_extract_embeddings(
    ...
    # Blind batch for baseline model (matches training)
    if is_baseline:
        print("  Blinding batch labels for baseline model...")
...
def main():
    ...
    BASELINE_PATH = PROJECT_ROOT / "benchmarks" / "results" / "baseline_amici_replicate_00"
    BA_AMICI_PATH = PROJECT_ROOT / "benchmarks" / "results" / "ba_amici_replicate_00"
    OUTPUT_DIR = PROJECT_ROOT / "benchmarks" / "validation_results"
